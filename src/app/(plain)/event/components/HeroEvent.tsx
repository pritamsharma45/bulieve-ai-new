...
const HeroEvent = () => {
  return (
    <section
      ...
      style={{ backgroundImage: `url(${bg7Img.src})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'top center' }}>
                ...
                <form className="row g-3 justify-content-center">
                  ...
                  <Col md={5}>
                    <div className="input-group">
                      ...
                      <Link className="position-absolute top-50 end-0 translate-middle-y text-secondary px-3 z-index-9" href="">
                        {' '}
                        <FaCrosshairs />{' '}
                      </Link>
                    </div>
