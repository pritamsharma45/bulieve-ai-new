...
const OverView = async () => {
  const allEventSchedules = await getAllEventSchedules()
  return (
        ...
        <Row className="g-4">
          ...
          <Col lg={8}>
            <Card className="card-body">
              ...
              <Image className="img-fluid mb-3" src={event6} alt="" />
                              ...
                              <Col sm={4} lg={3} key={idx}>
                                <Card className="card-body text-center">
                                  <div className="avatar avatar-lg mx-auto mb-3">
                                    {speaker?.avatar && <Image className="avatar-img rounded-circle" src={speaker.avatar} alt="image" />}
                                  </div>
                                  <div>
