      ...
      <Container>
        ...
        <Row className="g-4 g-lg-5">
          <Col md={4} className="text-center">
            <Image className="h-100px mb-4 w-auto" src={element2} alt="element" />
          ...
          <Col md={4} className="text-center">
            <Image className="h-100px mb-4 w-auto" src={element7} alt="element" />
          ...
          <Col md={4} className="text-center">
            <Image className="h-100px mb-4 w-auto" src={element1} alt="element" />
