    ...
    <section className="pt-5 pb-0 position-relative">
      <Container>
        ...
        <Row className="g-0 align-items-center mt-2 position-relative z-index-1">
          <Col lg={4}>
            <div className="iphone-x iphone-x-small" style={{ background: `url(${appPlaceholder.src})`, backgroundSize: '100%' }}>
              <i />
              <b />
            </div>
          </Col>
              ...
              <div className="mac_scaler">
                <div className="mac_holder">
                  <div className="mac_screen">
                    ...
                    <div className="mac_screen_content" style={{ background: `url(${macPlaceholder.src})`, backgroundSize: '100%' }}></div>
                  </div>
      ...
      <div className="position-absolute top-0 end-0 mt-5 pt-5">
        <Image className="h-300px blur-9 mt-5 pt-5 w-auto" src={element7} alt="image" />
      </div>
      <div className="position-absolute top-0 start-0 mt-n5 pt-n5">
        <Image className="h-300px blur-9 w-auto" src={element1} alt="image" />
      </div>
      <div className="position-absolute top-50 start-50 translate-middle">
        <Image className="h-300px blur-9 w-auto" src={element4} alt="image" />
      </div>
    </section>
  )
}
