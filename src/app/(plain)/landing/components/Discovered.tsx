          ...
          <Col lg={10} className="ms-auto">
            <Row className="g-4 align-items-center">
              <Col md={5} lg={5} className="position-relative">
                <Image className="rounded-circle" src={post1} alt="image" />
                <div className="position-absolute top-50 start-0 translate-middle d-none d-lg-block">
                  <div className="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                    <div className="avatar avatar-xs me-3">
                      <span role="button">
                        {' '}
                        <Image className="avatar-img rounded-circle" src={avatar12} alt="image" />{' '}
                      </span>
                    </div>
                  ...
                  <div className="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                    <div className="avatar avatar-xs me-3">
                      <span role="button">
                        {' '}
                        <Image className="avatar-img rounded-circle" src={avatar10} alt="image" />{' '}
                      </span>
                    </div>
                    <div className="d-flex">
                  ...
                  <div className="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                    <div className="avatar avatar-xs me-3">
                      <span role="button">
                        {' '}
                        <Image className="avatar-img rounded-circle" src={avatar9} alt="image" />{' '}
                      </span>
                    </div>
                    <div className="d-flex">
