  ...
  return (
    <section className="py-4 py-sm-5 position-relative">
      <div className="position-absolute top-0 start-0 mt-n5 pt-n5">
        <Image className="h-300px blur-9 w-auto" src={element6} alt="image" />
      </div>
      <Container>
        <Row>
          <Col lg={10} className="mx-auto">
            <Row className="g-4 align-items-center position-relative z-index-1">
              <Col md={6}>
                <div className="me-4">
                  ...
                  <div className="mb-3 d-flex align-items-start">
                    <Image width={44} height={40} className="h-40px w-auto" src={element4} alt="image" />
                    <div className="ms-4">
                  ...
                  <div className="mb-3 d-flex align-items-start">
                    <Image className="h-40px w-auto" src={element10} alt="image" />
                    <div className="ms-4">
              ...
              <Col md={6} lg={5} className="position-relative">
                <Image className="rounded-circle" src={post2} alt="image" />
                <div className="position-absolute top-50 start-100 translate-middle d-none d-lg-block">
                  <div className="position-absolute top-0 end-0 m-3 z-index-1">
                    <div className="avatar avatar-lg">
                      <span role="button">
                        <Image className="avatar-img rounded border border-white border-1" src={post7} alt="image" />
                      </span>
                    </div>
                  </div>
