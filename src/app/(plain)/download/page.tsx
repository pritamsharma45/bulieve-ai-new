  ...
  return (
    <main className="vh-100 py-5">
      <div className="position-absolute top-0 start-0 p-5">
        <Image className="h-100px blur-4" height={100} width={100} src={element8} alt="element" />
      </div>
      <div className="position-absolute bottom-0 start-0 m-5 p-5">
        <Image className="h-100px blur-7 m-5" width={100} height={100} src={element6} alt="image" />
      </div>
      <Container className="h-100 p-xl-0">
        <Row className="align-items-center h-100 g-4 g-xl-0 position-relative z-index-1 text-center text-lg-start">
          <Col lg={5}>
            ...
            <div className="d-flex justify-content-center justify-content-lg-start mt-4">
              <span role="button">
                <Image className="h-50px" width={160} height={50} src={appStore} alt="app-store" />
              </span>
              <span role="button">
                <Image className="h-50px ms-1 ms-sm-2" width={160} height={50} src={googlePlay} alt="google-play" />
              </span>
            </div>
          </Col>
          <div className="col-lg-7 position-relative">
            <div className="position-absolute top-0 start-0 mt-5 z-index-1 d-none d-lg-block">
              <Image alt="element" className="h-100px" width={105} height={100} src={element2} />
            </div>
            <div className="position-absolute top-0 end-0 d-none d-lg-block">
              <Image alt="element" className="h-100px" height={100} width={100} src={element3} />
            </div>
            <div className="position-absolute bottom-0 end-0 z-index-1 me-5 d-none d-lg-block">
              <Image alt="element" className="h-150px" src={element4} />
            </div>
            <div className="position-absolute top-50 start-0 translate-middle-y z-index-1 ms-5 ps-5 mt-5 d-none d-lg-block">
              <Image alt="element" className="h-100px w-auto" src={element7} />
            </div>
            <div className="position-absolute top-50 end-0 translate-middle-y z-index-1 d-none d-lg-block">
              <Image alt="element" className="h-50px blur-1" width={50} height={50} src={element6} />
            </div>
            <div className="position-absolute bottom-0 start-0 ms-5 ps-5 d-none d-lg-block">
              <Image alt="element" className="h-100px blur-2" width={100} height={100} src={element6} />
            </div>
            <div className="position-absolute top-50 end-0 translate-middle-y z-index-1 me-4 mt-n5 d-none d-lg-block">
              <Image alt="element" className="h-150px mt-n5 me-5 w-auto" src={element5} />
            </div>
            <div className="iphone-x" style={{ background: `url(${appPlaceholderImg.src})`, backgroundSize: 'cover' }}>
              <i />
              <b />
            </div>
          </div>
      ...
      <div className="position-absolute bottom-0 end-0 m-5 text-center d-none d-xl-block">
        ...
        <div className="mt-3">
          <Image className="w-100px" src={qrCode} alt="image" />
        </div>
      </div>
    </main>
  )
